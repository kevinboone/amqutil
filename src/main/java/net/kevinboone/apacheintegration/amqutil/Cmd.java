...
public abstract class Cmd
{
    ...
    /**
     * Set the command-line options that all commands will support. Specidic commands will usually
     * have to override this and add others.
     */
    ...
    public int doRun() throws Exception
    {
        ...
        logger = LoggerFactory.getLogger("net.kevinboone.apacheintegration");
    ...
    /**
     * Gets the ActiveMQ Connection factory from either host/port or URL. URL takes precedence.
     */
